 ...
 */
if ( 5 !== $argc ) {
	echo "Usage: php generate_aliases.php <output_directory> <directory> <original_namespace> <package_namespace>\n";
	exit( 1 ); // Exit with an error code.
}

// Get the input arguments from the terminal.
$output_directory   = $argv[1]; // The first argument is the directory where the file will be created.
$directory          = $argv[2]; // The first argument is the directory.
$original_namespace = $argv[3]; // The second argument is the original namespace.
$package_namespace  = $argv[4]; // The third argument is the package namespace.
