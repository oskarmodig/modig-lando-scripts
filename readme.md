...
| MOD_VAR_EXTRA_EXCLUDES           | Can be set to a comma-separated string with additional excludes. Used by `rsync`, so before composer/npm is run. The [default list of excludes](#default-list-of-excludes-for-deploy) can be found below. | unset                       |
...
| MOD_VAR_REMOVE_FILES_AFTER_BUILD | Can be set to a comma-separated string of paths to files to remove after composer/npm build process.                                                                                                      | unset                       |
...
| `modlan_ns_alias_helper.php` | Autogenerated namespace alias helper file                                                                                                                                                                                                      | 
